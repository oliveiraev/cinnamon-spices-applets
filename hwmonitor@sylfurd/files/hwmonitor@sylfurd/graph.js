...
class Graph {
  ...
  paint(area) {
    ...
    // Draw detail label
    if (this.show_detail) this.drawDetailLabel(cr);
  ...
  drawBorder(cr) {
    if (this.theme.theme == "light") cr.setSourceRGBA(1, 1, 1, 0.5);
    else if (this.theme.theme == "dark") cr.setSourceRGBA(0, 0, 0, 0.5);
    else {
      cr.setSourceRGBA(
        this.theme.border_colors[0],
        this.theme.border_colors[1],
        this.theme.border_colors[2],
        0.5
      );
    }
    cr.setLineWidth(1);
    cr.rectangle(0, 0, this.graph.outer.width, this.graph.outer.height);
    cr.stroke();
  }
  ...
  drawBackground(cr) {
    ...
    if (this.theme.theme == "light") {
      ...
      pattern.addColorStopRGBA(
        0,
        this.theme.background_colors1[0],
        this.theme.background_colors1[1],
        this.theme.background_colors1[2],
        0.7
      );
      pattern.addColorStopRGBA(
        1,
        this.theme.background_colors2[0],
        this.theme.background_colors2[1],
        this.theme.background_colors2[2],
        0.7
      );
    }
  ...
  drawGraphLines(cr) {
    ...
    cr.setLineWidth(1);
    if (this.theme.theme == "light") cr.setSourceRGBA(1, 1, 1, 0.4);
    else if (this.theme.theme == "dark") cr.setSourceRGBA(0, 0, 0, 0.4);
    else {
      cr.setSourceRGBA(
        this.theme.border_colors[0],
        this.theme.border_colors[1],
    ...
    cr.stroke();
    if (this.theme.theme == "light") cr.setSourceRGBA(1, 1, 1, 0.2);
    else if (this.theme.theme == "dark") cr.setSourceRGBA(0, 0, 0, 0.2);
    else {
      cr.setSourceRGBA(
        this.theme.border_colors[0],
        this.theme.border_colors[1],
  ...
  drawDataPoints(cr) {
    ...
    let pattern = new Cairo.LinearGradient(
      0,
      this.graph.inner.top,
      0,
      this.graph.inner.top + this.graph.inner.height
    );
    cr.setSource(pattern);
    if (this.theme.theme == "user")
      pattern.addColorStopRGBA(
        0,
        this.theme.graph_color4[0],
        this.theme.graph_color4[1],
        this.theme.graph_color4[2],
        1
      );
    else pattern.addColorStopRGBA(0, 1, 0, 0, 1);

    if (this.theme.theme == "user")
      pattern.addColorStopRGBA(
        this.theme.graph_offset3,
        this.theme.graph_color3[0],
        this.theme.graph_color3[1],
        this.theme.graph_color3[2],
        1
      );
    else pattern.addColorStopRGBA(0.5, 1, 1, 0.2, 1);

    if (this.theme.theme == "user")
      pattern.addColorStopRGBA(
        this.theme.graph_offset2,
        this.theme.graph_color2[0],
        this.theme.graph_color2[1],
        this.theme.graph_color2[2],
        1
      );
    else pattern.addColorStopRGBA(0.7, 0.4, 1, 0.3, 1);

    if (this.theme.theme == "user")
      pattern.addColorStopRGBA(
        1,
        this.theme.graph_color1[0],
        this.theme.graph_color1[1],
        this.theme.graph_color1[2],
        1
      );
    else pattern.addColorStopRGBA(1, 0.2, 0.7, 1, 1);
    cr.fill();
  }
  ...
  drawLabel(cr) {
    ...
    if (this.theme.theme == "light") cr.setSourceRGBA(0.8, 0.8, 0.8, 0.5);
    else if (this.theme.theme == "dark") cr.setSourceRGBA(0.2, 0.2, 0.2, 0.5);
    else {
      cr.setSourceRGBA(
        this.theme.label_color[0],
        this.theme.label_color[1],
        this.theme.label_color[2],
        0.5
      );
    }
    cr.moveTo(
      global.ui_scale * 1.5,
      global.ui_scale * this.theme.label_size + 1
    );
    ...
    if (this.theme.cpu_use_custom_label && this.provider.type == "CPU")
      ...
      this.theme.netout_use_custom_label &&
      this.provider.type == "NETOUT"
    )
      cr.showText(this.theme.netout_custom_label);
    else cr.showText(this.provider.name);

    if (this.theme.theme == "light") cr.setSourceRGBA(0.8, 0.8, 0.8, 1);
    else if (this.theme.theme == "dark") cr.setSourceRGBA(0.2, 0.2, 0.2, 1);
    else {
      cr.setSourceRGBA(
        this.theme.label_color[0],
        this.theme.label_color[1],
    ...
    cr.moveTo(
      global.ui_scale * 1,
      global.ui_scale * this.theme.label_size + 0.5
    );
  ...
  // Draw the text label on the graph
  drawDetailLabel(cr) {
    if (this.provider.text == null) return;

    cr.setFontSize(this.theme.detail_label_size);
    if (this.theme.theme == "light") cr.setSourceRGBA(0.7, 0.7, 0.7, 0.5);
    else if (this.theme.theme == "dark") cr.setSourceRGBA(0.1, 0.1, 0.1, 0.5);
    else {
      cr.setSourceRGBA(
        this.theme.detail_label_color[0],
        this.theme.detail_label_color[1],
        this.theme.detail_label_color[2],
        0.5
      );
    }
    cr.moveTo(
      global.ui_scale * 1.5,
      global.ui_scale *
        (this.theme.label_size + this.theme.detail_label_size + 0.5) +
        0.5
    );

    cr.showText(this.provider.text);

    if (this.theme.theme == "light") cr.setSourceRGBA(0.7, 0.7, 0.7, 1);
    else if (this.theme.theme == "dark") cr.setSourceRGBA(0.1, 0.1, 0.1, 1);
    else {
      cr.setSourceRGBA(
        this.theme.detail_label_color[0],
        this.theme.detail_label_color[1],
    ...
    cr.moveTo(
      global.ui_scale * 1,
      global.ui_scale * (this.theme.label_size + this.theme.detail_label_size) +
        0.5
    );
