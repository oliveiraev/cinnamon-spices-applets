...
var DarkSky = (function() {
  ...
  DarkSky.prototype.ParseWeather = function(json) {
    try {
      ...
      this.app.weather.sunrise = new Date(
      ...
      this.app.weather.main.temperature = this.ToKelvin(
      ...
      this.app.weather.condition.main = this.GetShortCurrentSummary(
        json.currently.summary
      );
      this.app.weather.condition.description = json.currently.summary;
      this.app.weather.condition.icon = weatherIconSafely(
        this.ResolveIcon(json.currently.icon),
        this.app._icon_type
      );
      this.app.weather.cloudiness = json.currently.cloudCover * 100;
      this.app.weather.main.feelsLike = this.ToKelvin(
        json.currently.apparentTemperature
      );
      for (var i = 0; i < this.app._forecastDays; i++) {
        ...
        forecast.condition.icon = weatherIconSafely(
          this.ResolveIcon(day.icon),
          this.app._icon_type
        );
