...
var clearTimeout = function(id) { Mainloop.source_remove(id); };
...
var GetHoursMinutes = function(date, locale, hours24Format, tz) {
  ...
  case "notz":
    return date.toLocaleString(
        locale,
        {hour : "numeric", minute : "numeric", hour12 : !hours24Format});
  case "none":
...
var AwareDateString = function(date, locale, hours24Format) {
  var support = isLocaleStringSupported();
  var now = new Date();
  var params = {hour : "numeric", minute : "numeric", hour12 : !hours24Format};
...
var KPHtoMPS = function(speed) { return speed / WEATHER_CONV_KPH_IN_MPS; };
...
var FahrenheitToKelvin = function(
    fahr) { return ((fahr - 32) / 1.8 + 273.15); };
var MPHtoMPS = function(speed) { return speed * 0.44704; };
...
var nonempty = function(str) { return (str != null && str.length > 0); };
var compassDirection = function(deg) {
  var directions =
      [ _('N'), _('NE'), _('E'), _('SE'), _('S'), _('SW'), _('W'), _('NW') ];
